...
func Test_AskDistance(t *testing.T) {
	...
	t.Run("should return the inputed number", func(t *testing.T) {
		...
		io.On("AskFloat", constants.QuestionDistance).Return(expected, nil).Once()
	...
	t.Run("should not return zero", func(t *testing.T) {
		// Arrange
		io.On("AskFloat", constants.QuestionDistance).Return(float64(0), nil).Once()
	...
	t.Run("should not return numbers lower than zero", func(t *testing.T) {
		// Arrange
		io.On("AskFloat", constants.QuestionDistance).Return(float64(-12), nil).Once()
	...
	t.Run("should return error", func(t *testing.T) {
		...
		io.On("AskFloat", constants.QuestionDistance).Return(float64(0), expected).Once()
